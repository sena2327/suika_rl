...
const Game = {
	...
	initGame: function () {
		...
		const dropFruitButton = document.getElementById('drop-fruit-button');
		dropFruitButton.addEventListener('click', function() {
			const fruitPositionInput = document.getElementById('fruit-position');
			const x = parseInt(fruitPositionInput.value, 10);
			Game.addFruit(x);
		});
